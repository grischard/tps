...
describe Administrateur, type: :model do
  ...
  context 'unified login' do
    it 'syncs credentials to associated user' do
      ...
      administrateur.update_attributes(email: 'whoami@plop.com', password: 'voilà un super mdp')
    ...
    it 'syncs credentials to associated administrateur' do
      ...
      administrateur.update_attributes(email: 'whoami@plop.com', password: 'et encore un autre mdp')
